  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ bgcolor: '#F9FAFB', borderRadius: 2, p: 3, mb: 2, boxShadow: '0 1px 2px rgba(16,30,115,0.04)' }}>
          ...
          <Box sx={{ mb: 1 }}>
            ...
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Box sx={{ flex: 1.2, px: 0.5 }}>RM Remarks</Box>
              </Box>
              {/* Table Rows */}
                ...
                displayData.map((request) => {
                  ...
                  return (
                    <Box key={request.id} sx={{ display: 'flex', alignItems: 'center', borderTop: '1px solid #E5E7EB', p: 1 }}>
                      ...
                      <Box sx={{ flex: 1.2, fontSize: 14, color: '#111827', px: 0.5 }}>
